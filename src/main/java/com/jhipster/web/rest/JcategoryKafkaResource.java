...
@RestController
@RequestMapping("/api/jcategory-kafka")
public class JcategoryKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JcategoryKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JcategoryKafkaResource(KafkaProperties kafkaProperties) {
